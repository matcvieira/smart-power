...
*class* SubstationDialog(*[parent]*)
===============================================
**Herança:**

* **parent -** PySide.QtGui.QWidget

Classe que implementa a Dialog de configuração do Subestação.
...
Metodo inicial (construtor) da classe SubstationDialog. É chamada quando um objeto da classe Node e do tipo Subestação (item) é inserido no diagrama, ou quando um evento DoubleClick é realizado nesse objeto.
